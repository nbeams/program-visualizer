...
DEPENDPATH += src
INCLUDEPATH += src ../../editor/src ../../libraries/extraGUI/src ../../libraries/program_visualizer/src
DESTDIR = .
...
LIBS += -L../../libraries/extraGUI -L../../libraries/program_visualizer -lextraGUI -lprogram_visualizer -lqscintilla2
...
macx:{
install_lib_names.extra = sh ../../scripts/osx_install_names.sh ../../$${INSTALL_BASE}/targets/cbc/libcbc_plugin.dylib QtCore.framework/Versions/4/QtCore QtGui.framework/Versions/4/QtGui QtSvg.framework/Versions/4/QtSvg
